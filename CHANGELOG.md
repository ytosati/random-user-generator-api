...
1. Implementada interface web que realiza as mesmas operações que a api, uma vez que a api está rodando e o banco conectado.
2. Página do swagger é aberta automaticamente com a documentação ao iniciar a api.
3. Logs do arquivo readme passadas para esse, e arquivo readme desenvolvido com mais informações.